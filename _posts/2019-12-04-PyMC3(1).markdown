...
```
<center><img src="https://imgur.com/vAKgqjB.png" width="90%" height="60%"></center>
...
with pm.Model() as model:
    ...
    pm.traceplot(trace);
```
<center><img src="https://imgur.com/Y5Q0GP4.png" width="60%" height="60%"></center>
