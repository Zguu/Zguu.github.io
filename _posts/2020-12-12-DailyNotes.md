...
<center><img src="https://i.imgur.com/dSrBVep.png" width="40%" height="40%"></center>
...
목표 벡터 설정에서 "나는 모든 값들을 10으로 만들고 싶어". "feature의 갯수를 20개로 늘려서 모든 분야(feature)에서 완벽한 사람이 되고싶어!" 라는 비현실적인 목표설정이 얼마나 독소적인지에 대해서는 말할 필요가 없을 것이다.
